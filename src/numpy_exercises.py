...
print('2D array => 1D array sort => 2D array')
x19 = x16.reshape(-1)
print(np.shares_memory(x16, x19))
x19 = x19.copy()
print(np.shares_memory(x16, x19))
print(x19)
x19.sort()
print(x19)
x19 = x19.reshape(x16.shape)
print(x19)


print('Set logic')
x20 = np.random.randint(0, 8, 16)
x21 = np.random.randint(4, 12, 16)
print(f'x20: {x20}')
print(f'x21: {x21}')
print(f'Unique: {np.unique(x20)}')
print(f'Union: {np.union1d(x20, x21)}')
print(f'Intersection: {np.intersect1d(x20, x21)}')
print(f'Isin: {np.isin(x20, x21)}')
